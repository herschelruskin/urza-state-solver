...
def make_bounded_contingent_tutor_runner(
    *,
    ...
    def runner(runtime,*,root_action,horizon,policy,max_steps):
        ...
        # Internal Q continuations only need a short diagnostic tail. Retaining
        # full 512-step histories across thousands of nested rollout branches
        # creates large transient heaps without affecting terminal values/actions.
