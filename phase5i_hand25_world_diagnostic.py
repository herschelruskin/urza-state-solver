#!/usr/bin/env python3
"""Factorized diagnostic for the pathological Phase-5I human hand 25.
...
def main():
    ...
    payload = {
        "kind": "phase5i-hand25-world-diagnostic",
        "hand_id": HAND_ID,
        "stage": STAGE,
    ...
    out = Path(f"phase5i_hand25_diag_{safe}_n{int(args.sample_id)}.json")
