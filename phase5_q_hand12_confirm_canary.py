#!/usr/bin/env python3
"""Single-world hand-12 canary for independent Q confirmation."""
...
def main():
    ...
    Path("phase5_q_hand12_confirm_canary.json").write_text(json.dumps(payload,indent=2)+"\n")
    print("HAND12="+json.dumps(payload,sort_keys=True))
