...
transitions to ``non_oracle_rules_adapter`` and only merges the narrowly evidenced
fetchland and Knack/Helix activation surfaces from
``non_oracle_public_parity_runtime``.
"""
